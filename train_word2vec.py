...
neutral_text1 = open('./data_raw/test_nhan_2.txt', 'r', encoding='utf-8').read()
positive_text = open('./data_raw/train_nhan_0.txt', 'r', encoding='utf-8').read()
negative_text = open('./data_raw/train_nhan_1.txt', 'r', encoding='utf-8').read()
neutral_text = open('./data_raw/train_nhan_2.txt', 'r', encoding='utf-8').read()
