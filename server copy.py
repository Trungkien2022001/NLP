...
def get_data():
    ...
    try:
        ...
        if 'input' in data:
            ...
            data = TfidfVectorizer(analyzer='word', max_features=30000)

            
            data.fit(X_data) # learn vocabulary and idf from training set
            ...
            X_data_ =  data.transform(X_data)
            X_test_ =  data.transform(X_test)
            ...
            encoder.classes_
            a = train_model(MultinomialNB(), X_data_, y_data, X_test_, y_test, input_data, is_neuralnet=False)
